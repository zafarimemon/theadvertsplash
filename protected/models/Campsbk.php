...
/**
 * This is the model class for table "campsbk".
 *
 * The followings are the available columns in table 'campsbk':
 * @property integer $id
 ...
 */
class Campsbk extends CActiveRecord
{
	/**
	 ...
	 * @return Campsbk the static model class
	 */
