                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Edit Apps</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                    	<form method="POST" action="<?php echo Yii::app()->baseUrl?>/apps/update">
											<div class="mb-3 row">
	                                            <label for="example-text-input" class="col-md-2 col-form-label">App Name</label>
	                                            <div class="col-md-10">
	                                                <input class="form-control" name="domain" type="text" value="<?php echo $site->domain?>" id="example-text-input" required="">
	                                                <input class="form-control" name="site_id" type="hidden" value="<?php echo $site->site_id?>">
	                                            </div>
	                                        </div>
	                                        ...
	                                        <div class="mb-3 row">
	                                            ...
	                                            <div class="col-md-10">
	                                                <input class="form-control" name="stat_url" type="text" value="<?php echo $site->stat_url?>" id="example-text-input" required="">
	                                            </div>
	                                        </div>
	                                            ...
	                                            <div class="col-md-10">
	                                                <select class="form-control" name="user_id" required=""> 
	                                                	...
	                                                	<?php foreach($users as $user):?>
	                                                		<option value="<?php echo $user->id?>" <?php echo ($site->user_id==$user->id)?'selected':''?>><?php echo ucfirst($user->username.' - '.$user->email)?></option>
	                                                	<?php endforeach;?>
	                                                </select>
	                                            </div>
	                                        </div>
